...
import { OnboardingTerminal } from "@/components/auth/onboarding-terminal";
        ...
        <div className="relative px-8 lg:px-12 pt-10 lg:pt-12">
          ...
          <div className="mt-12 lg:mt-20 max-w-xl">
            <h1 className="font-sans font-bold tracking-tight leading-[1.05] text-[36px] sm:text-[42px]">
              ...
              <br />
              <span className="text-white/35">anything on screen.</span>
            </h1>
      ...
      >
        ...
        <div className="w-full max-w-[380px] mx-auto">
          ...
          <motion.p
            ...
            className="mt-2 mb-8 text-[14px] text-white/50 leading-relaxed"
          >
            No credit card required. 100 executions free every month.
          </motion.p>
