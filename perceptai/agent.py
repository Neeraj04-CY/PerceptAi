    ...
    def execute_step(self, step):
        ...
        if action == "open_app":
            ...
            if element:
                ...
                if query.lower() in ("address", "search"):
                    print("    Address/Search not found — using Alt+D")
                    pyautogui.hotkey("alt", "d")
                    return {"success": True, "action": "hotkey", "keys": ["alt", "d"]}
            ...
            text = os.path.expandvars(step.get("text", ""))
            print(f"    Typing: '{text}'")
